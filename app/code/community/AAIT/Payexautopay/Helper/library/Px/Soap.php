...
class Payexautopay_Px_Soap
{
    ...
    static public function getClient()
    {
        ...
        $adapter_class = 'Payexautopay_Px_Soap_' . self::$_adapter_name;
        ...
        throw new Payexautopay_Px_Exception('Soap Adapter not available.');
    }

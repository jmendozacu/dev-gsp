<?php
class Ecom_Utils_Helper_Discount extends Ecom_Utils_Helper_Data {
	...
	public function getOrderDiscount($order){
		...
		else return $this->getOrderDiscountData($quote)->getDiscountExclTax();
	
	}
	
	public function getOrderDiscountData($order) {

		$CatPriceIncl = Mage::getStoreConfig('tax/calculation/price_includes_tax',$order->getStore());

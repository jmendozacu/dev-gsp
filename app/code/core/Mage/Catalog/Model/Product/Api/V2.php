...
class Mage_Catalog_Model_Product_Api_V2 extends Mage_Catalog_Model_Product_Api
{
    ...
    protected function _prepareDataForSave ($product, $productData)
    {
        ...
        if (property_exists($productData, 'group_price')) {
            $groupPrices = Mage::getModel('catalog/product_attribute_groupprice_api_V2')
             ->prepareGroupPrices($product, $productData->group_price);
            $product->setData(Mage_Catalog_Model_Product_Attribute_Groupprice_Api_V2::ATTRIBUTE_CODE, $groupPrices);
        }  
    }

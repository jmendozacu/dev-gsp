    ...
    public function getGeneralInfoForm()
    {
        ...
        if (count($rmas)) {
            ...
            $fieldset->addField('note', 'note', array(
                'label' => $this->__('Another RMA for this order'),
        ...
        if ($rma->getCreditMemoIds()) {
            ...
            foreach ($rma->getCreditMemoIds() as $id) {
                ...
                $links[] = "<a href='".$this->getUrl('adminhtml/sales_creditmemo/view', array('creditmemo_id' => $id))."'>#".$creditmemo->getIncrementId().'</a>';
            }
            $fieldset->addField('credit_memo_id', 'note', array(
